...
#def cluster_signalToNoise(directory,time_limits=None,spike_clusters,sigma=5.,number_to_average=250,plots=False,channels='all'):
def cluster_signalToNoise(directory,filename,time_limits=None,sigma=5.,number_to_average=250,plots=False,channels='all'):
    spike_clusters_path = os.path.join(directory,'spike_clusters.npy')
    spike_templates_path = os.path.join(directory,'spike_templates.npy')
    spike_times_path = os.path.join(directory,'spike_times.npy')
    params_path = os.path.join(directory,'params.py')
    ...
    filename = '20200922_t1_AB_g0_t0.imec0.ap.bin'
    print(filename)
    if os.path.isfile(spike_clusters_path):
        spike_clusters = np.load(spike_clusters_path)
    else:
